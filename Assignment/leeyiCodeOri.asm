...
main proc  
    ...
    mov ah,2
    call topLeftTriangle
    mov ah,2
    call topRightTriangle
    mov ah,2
    call bottomLeftTriangle
    mov ah,2
    call bottomRightTriangle
...
topLeftTriangle proc  
    ...
    NP01start:
        ...
        sub cx,bx
        CMP bx,0
        JE topLeftTriangle_end ;jmp to end
